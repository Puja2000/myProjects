        ...
        <div className="m-auto w-full md:max-w-[500px] py-4 md:py-4 md:px-10 lg:px-24 h-full lg:h-auto bg-white bg-opacity-20 backdrop-blur-ls rounded drop-shadow-lg">
            <div className="mx-auto w-[300px]">
                <section className="text-center">
                    ...
                    <p className="text-sm font-medium">{today.weather[0].main} {today.weather[0].description}</p>
                ...
                <section className="flex flex-wrap justify-between text-zinc-700">
                    ...
                    {/* pressure */}
                    <Tile icon="pressure" title="Pressure" info={`${Math.round(today.main.pressure)} hPa`} description={`${Math.round(today.main.pressure) < 1013 ? 'Lower' : 'Higher'}`}/>
                    {/* visibility */}
